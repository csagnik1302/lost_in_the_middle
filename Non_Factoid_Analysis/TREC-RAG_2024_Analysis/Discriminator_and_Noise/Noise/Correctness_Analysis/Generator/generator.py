...
if __name__=='__main__':
    ...
    retr_set_path=r'/home/irlab/sagnik/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Data/bm25/generator_input_data_gold_fixed_3.jsonl'
    ...
    output_text, query=llm_output_generator(0,3,model,tokenizer,retr_set_path)

    print(output_text)

    export_output={'query':query,'generator_llm_output':output_text}

    with open(r'/home/irlab/sagnik/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Noise/Correctness_Analysis/misc/bm25/sample_output_generator.json','w') as f:
