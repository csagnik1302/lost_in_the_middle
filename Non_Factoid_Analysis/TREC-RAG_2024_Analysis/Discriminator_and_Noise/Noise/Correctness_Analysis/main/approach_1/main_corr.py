...
with open(rf'/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Noise/Correctness_Analysis/misc/{method}/itr_index_app1.json','r') as f:
    itr=json.load(f)

unified_itr=[]
with open(rf'/home/irlab/sagnik/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Noise/Correctness_Analysis/misc/{method}/pipeline_error_log_gold_{gold_count}_{model_name[model_name.index('/')+1:]}_app1_2nd.jsonl','r') as f:
    for i in f:
...
for i,j in tqdm(unified_itr1):
    ...
    try:
        ...
        with open(fr"/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Noise/Correctness_Analysis/misc/{method}/pipeline_output_gold_{gold_count}_{model_name[model_name.index('/')+1:]}_app1.jsonl", "a") as f:
        ...
        with open(fr"/home/irlab/sagnik/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Noise/Correctness_Analysis/misc/{method}/pipeline_error_log_gold_{gold_count}_{model_name[model_name.index('/')+1:]}_app1_2nd.jsonl", "a") as f:
