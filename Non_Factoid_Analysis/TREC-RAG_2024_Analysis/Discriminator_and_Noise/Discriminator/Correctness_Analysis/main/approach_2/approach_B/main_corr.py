...
with open(rf'/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Discriminator/Correctness_Analysis/misc/{method}/itr_index_without_rag.json','r') as f:
    itr=json.load(f)

unified_itr=[]
with open(rf'/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Discriminator/Correctness_Analysis/misc/{method}/pipeline_error_log_{model_name[model_name.index('/')+1:]}_without_rag.jsonl','r') as f:
    for i in f:
...
for i,j in tqdm(unified_itr1):
    ...
    try:
        ...
        with open(fr"/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Discriminator/Correctness_Analysis/misc/{method}/pipeline_output_{model_name[model_name.index('/')+1:]}_without_rag.jsonl", "a") as f:
        ...
        with open(fr"/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Discriminator/Correctness_Analysis/misc/{method}/pipeline_error_log_{model_name[model_name.index('/')+1:]}_2nd.jsonl", "a") as f:
