...
if __name__=="__main__":
    ...
    with open(r'/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Data/bm25/generator_input_data_id_gold_fixed_3_without_rag.jsonl', 'r') as f:
        for i in f:
            temp=json.loads(i)
    ...
    for i in tqdm(retr_set):
        ...
        with open(r"/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Data/bm25/generator_input_data_gold_fixed_3_without_rag.jsonl", "a") as f:
