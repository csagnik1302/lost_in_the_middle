...
if __name__=="__main__":
    ...
    with open(rf'/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Data/bm25/generator_input_data_id_gold_fixed_{gold_count}_app2A.jsonl', 'r') as f:
        for i in f:
            temp=json.loads(i)
    ...
    for i in tqdm(retr_set):
        ...
        with open(rf"/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2024_Analysis/Discriminator_and_Noise/Data/bm25/generator_input_data_gold_fixed_{gold_count}_app2A.jsonl", "a") as f:
