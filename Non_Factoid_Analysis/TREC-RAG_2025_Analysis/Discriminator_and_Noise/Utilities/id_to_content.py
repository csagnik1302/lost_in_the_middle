...
if __name__=="__main__":
    ...
    with open(fr'/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2025_Analysis/Discriminator_and_Noise/Data/{method}/generator_input_data_id_gold_fixed_3.jsonl', 'r') as f:
        for i in f:
            temp=json.loads(i)
    ...
    for i in tqdm(retr_set):
        ...
        with open(fr"/home/irlab/sagnik/Non_Factoid_Analysis/TREC-RAG_2025_Analysis/Discriminator_and_Noise/Data/{method}/generator_input_data_gold_fixed_3.jsonl", "a") as f:
