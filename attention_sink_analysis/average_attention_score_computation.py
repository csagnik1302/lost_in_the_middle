...
for l in tqdm(range(prompt_count)):
    ...
    torch.save((1/(l+1))*sum_score_prompt,f"/home/irlab/sagnik/attention_sink_analysis/Plot/Average_Attention_Weights/{model_name}/across_layer_importance_score_prompt_count_{prompt_count}_doc_count_{doc_count}_gold_{gold_count}.pt")

across_prompt_importance_score=(1/prompt_count)*sum_score_prompt

torch.save(across_prompt_importance_score,f"/home/irlab/sagnik/attention_sink_analysis/Plot/Average_Attention_Weights/{model_name}/across_layer_importance_score_prompt_count_{prompt_count}_doc_count_{doc_count}_gold_{gold_count}.pt")
...
plt.savefig(f"/home/irlab/sagnik/attention_sink_analysis/Plot/Average_Attention_Weights/{model_name}/attention_score_prompt_count_{prompt_count}_doc_count_{doc_count}_gold_{gold_count}.png", dpi=300, bbox_inches="tight")
