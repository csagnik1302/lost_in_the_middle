...
# with open(r'C:\lost-in-the-middle\TREC-RAG_2024_Analysis\Discriminator_and_Noise\Discriminator\Data\generator_input_data_gold_fixed_3.jsonl', 'r') as f:
#     for i in f:
#         temp=json.loads(i)
...
# with open(r'C:\lost-in-the-middle\TREC-RAG_2024_Analysis\Discriminator_and_Noise\Discriminator\Data\query_rag24.jsonl','r') as f:
#     for i in f:
...
# with open(r'C:\lost-in-the-middle\TREC-RAG_2024_Analysis\Discriminator_and_Noise\Discriminator\Misc\sample_prompt.json', 'r', encoding='utf-8') as f:
#     prompt = json.load(f)
